...
def run_backtest():
    ...
    plt.title("Equity Curve - Systematic FX Mean Reversion (EURUSD)")
    plt.xlabel("Date")
    plt.ylabel("Equity ($)")
    plt.tight_layout()
    plt.savefig("equity_curve.png", dpi=150)
    print("equity_curve.png salvato in:", os.path.abspath("equity_curve.png"))
    plt.show()      # <-- così LO VEDI nel notebook
    plt.close()
